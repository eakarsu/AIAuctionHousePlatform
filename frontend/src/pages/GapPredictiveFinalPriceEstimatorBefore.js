...
// v0 scaffold for: Predictive final-price estimator before auction close
// Generated by batch_00 audit. Wire to real API; v0 calls /api/cf-predictive-final-price-estimator-before/run.

export default function PredictiveFinalPriceEstimatorBeforePage() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/cf-predictive-final-price-estimator-before/run', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>Predictive final-price estimator before auction close</h1>
