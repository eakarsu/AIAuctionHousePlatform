...
// v0 scaffold for: Invaluable, Artnet, and eBay Live Auctions API connectors
// Generated by batch_00 audit. Wire to real API; v0 calls /api/cf-invaluable-artnet-ebay-live-auctions/run.

export default function InvaluableArtnetEbayLiveAuctionsPage() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/cf-invaluable-artnet-ebay-live-auctions/run', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>Invaluable, Artnet, and eBay Live Auctions API connectors</h1>
