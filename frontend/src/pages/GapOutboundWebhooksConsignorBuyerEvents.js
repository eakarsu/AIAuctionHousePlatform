...
// v0 scaffold for: No outbound webhooks for consignor / buyer events
// Generated by batch_00 audit. Wire to real API; v0 calls /api/gap-outbound-webhooks-consignor-buyer-events/run.

export default function OutboundWebhooksConsignorBuyerEventsPage() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/gap-outbound-webhooks-consignor-buyer-events/run', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>No outbound webhooks for consignor / buyer events</h1>
