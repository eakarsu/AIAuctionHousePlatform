...
// v0 scaffold for: Real-time auction streaming with AI-managed bid increments
// Generated by batch_00 audit. Wire to real API; v0 calls /api/cf-real-time-auction-streaming-ai/run.

export default function RealTimeAuctionStreamingAiPage() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/cf-real-time-auction-streaming-ai/run', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>Real-time auction streaming with AI-managed bid increments</h1>
