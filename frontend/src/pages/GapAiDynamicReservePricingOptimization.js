...
// v0 scaffold for: No AI dynamic reserve-pricing optimization
// Generated by batch_00 audit. Wire to real API; v0 calls /api/gap-ai-dynamic-reserve-pricing-optimization/run.

export default function AiDynamicReservePricingOptimizationPage() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/gap-ai-dynamic-reserve-pricing-optimization/run', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>No AI dynamic reserve-pricing optimization</h1>
