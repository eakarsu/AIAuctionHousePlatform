...
// v0 scaffold for: No insurance-policy management module
// Generated by batch_00 audit. Wire to real API; v0 calls /api/gap-insurance-policy-management-module/run.

export default function InsurancePolicyManagementModulePage() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/gap-insurance-policy-management-module/run', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>No insurance-policy management module</h1>
