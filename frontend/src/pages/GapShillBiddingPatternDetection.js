...
// v0 scaffold for: Shill-bidding pattern detection
// Generated by batch_00 audit. Wire to real API; v0 calls /api/cf-shill-bidding-pattern-detection/run.

export default function ShillBiddingPatternDetectionPage() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/cf-shill-bidding-pattern-detection/run', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>Shill-bidding pattern detection</h1>
